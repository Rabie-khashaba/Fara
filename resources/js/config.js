...
class Config {
     ...
     setConfig() {
          ...
          var savedConfig = localStorage.getItem("__Farra_CONFIG__");
          // var savedConfig = sessionStorage.getItem("__Farra_CONFIG__");
     ...
     init() {
          try {
               ...
               localStorage.setItem('__Farra_CONFIG__', JSON.stringify(this.config));
               this.setConfig();
          }
     }
}
