@extends('layouts.vertical', ['title' => 'Edit Role', 'subTitle' => 'Settings'])
...
<div class="card">
    ...
    <div class="card-body">
        ...
        @endif
        <form method="POST" action="{{ route('settings.roles.update', $role->id) }}">
            @csrf
            @method('PUT')
            <div class="row">
            ...
            <div class="d-flex justify-content-end gap-2">
                <a href="{{ route('settings.roles.show', $role->id) }}" class="btn btn-light">Cancel</a>
